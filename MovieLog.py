...
while True:
    ...
    action = input("\nEnter 'a' to add a movie, 's' to search for a movie, 'u' to undo your last entry, or 'q' to quit: ")
    ...
    if action.lower() == "a":
        ...
        if confirm.lower() == "y":
            ...
            print("Entry not added to the movie log.")
    ...
    # Search for a movie in the log
        ...
        if not found_movie:
            print(f"{title} not found in the movie log.")
